...
const infoData = [
    ...
    },
    {
        ...
        details:'On the basement floor of the MediClinic Hospital, one will find many highly specialized medical equipment where the Nuclear located.',
        icon: faMapMarked,
        ...
        <div>
           <section className=" container">
            <div className="row py-5">
                {
                    infoData.map(info => <InfoDiv info={info} />)
                }
            </div>
